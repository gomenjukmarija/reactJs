...
//  Like automatic binding, controlled vs uncontrolled components is a topic that you should be familiar with,
// but don't need to understand deeply at this point.
//
// An uncontrolled component is a component that maintains its own internal state.
// A controlled component is a component that does not maintain any internal state. Since a controlled component has no state,
...
// The important thing here is that the <input /> keeps track of its own text.
// You can ask it what its text is at any time, and it will be able to tell you.
//
...
//
// In React, when you give an <input /> a value attribute,
// then something strange happens: the <input /> BECOMES controlled.
// It stops using its internal storage. This is a more 'React' way of doing things.
//
//You can find more information about controlled and uncontrolled components in https://reactjs.org/docs/forms.html